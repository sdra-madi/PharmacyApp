...
<body style="background: url(Bubble-Background.svg) ;">
  <div class="container  d-flex justify-content-center pt-5">
   ...
   <div class="form-group mt-5 ">
    ...
    <input type="phone" name="phone_number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style="text-align: right;"
      placeholder="أدخل رقمك الهاتف">
   </div>
  ...
  <div class="h22">
    ...
    style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
    <a href="{{route('create1')}}">إنشاء حساب</a>
  </button>
