...
<form method="POST" action="createware" enctype="multipart/form-data">
    @csrf
<div class="input"
 style="  display: flex;
...
<div class="di1">
    <label for="uname" class="lable" >
      <b style="margin-left: 200px;"> :اسم المستودع</b>
    ...
    <label for="uname" class="lable" >
      ...
      <label for="uname" class="lable" >
        <b style="margin-left: 215px;"> :رقم هاتف الارضي</b>
        <input type="text" name="phone_number_land" class="inpu border" style="text-align: right;"
         placeholder="ادخل رقم  هاتف الارضي" ></input>
      </label>
      <span style="color:red">@error('phone_number_land'){{$message}}@enderror</span>
</div>
          <div class="di2">
        ...
        <div class="di3">
              <label for="uname" class="lable" >
                <b style="margin-left: 215px;"> :رقم هاتف الاتصال</b>
                <input type="text" name="phone_number_call" class="inpu border" style="text-align: right;"
                 placeholder="ادخل رقم  هاتف الاتصال" ></input>
              </label>
              <span style="color:red">@error('phone_number_call'){{$message}}@enderror</span>
              <label for="uname" class="lable" >
                <b style="margin-left: 215px;"> :رقم الوتس</b>
                <input type="text" name="phone_number_whatsup" class="inpu border" style="text-align: right;"
                 placeholder="ادخل رقم الوتس"></input>
              </label>
              <span style="color:red">@error('phone_number_whatsup'){{$message}}@enderror</span>
